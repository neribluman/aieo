    ...
    <main className="relative">
      ...
      <div className="h-screen relative overflow-hidden bg-gradient-to-b from-white via-purple-50 to-white">
        ...
        <div className="relative z-10 h-screen flex flex-col">
          {/* Hero Section */}
          <div className="flex-1 flex items-start justify-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
            <motion.div 
            ...
            >
              ...
              >
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-geist-sans font-light tracking-tight text-gray-900">
                  Shape how
                  <motion.span 
                    className="block mt-6 mb-6 font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text leading-tight py-2"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.4, duration: 0.8 }}
                  >
                    AI ranks your product
                  </motion.span>
                </h1>
