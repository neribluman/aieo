...
export default function VisibilityDashboard() {
  ...
  // Add this function to render the query table
  const renderQueryTable = (queries: QueryPerformance[]) => {
    const platforms = ['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'AIO'];
        ...
        <div className="bg-white border rounded-lg shadow-lg">
          <div className="relative">
            ...
            <div className="divide-y divide-gray-200">
              {queries.map((query) => (
                <div key={query.id} className="hover:bg-blue-50 transition-all duration-200">
                  <div className="grid items-center" style={{ gridTemplateColumns: '1fr repeat(5, 80px)' }}>
                    <div className="px-3 py-2 min-w-0">
                      <Text className="text-gray-900 truncate">{query.query}</Text>
                    </div>
                    {platforms.map(platform => {
