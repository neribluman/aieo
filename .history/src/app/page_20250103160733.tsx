...
export default function LandingPage() {
  ...
  return (
    <main className="relative">
      ...
      <div className="h-screen relative overflow-hidden bg-gradient-to-b from-white via-purple-50 to-white z-30">
        {/* Grid background */}
      ...
      <div className="relative z-20">
        <HorizontalScroll onScrollComplete={handleScrollComplete}>
      ...
      <div 
        ...
        style={{ 
          ...
          transform: showPricing ? 'translateY(0)' : 'translateY(20px)',
          pointerEvents: showPricing ? 'auto' : 'none'
        }}
      >
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-white via-purple-50 to-white">
          {/* Background Layer */}
