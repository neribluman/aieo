...
export function SarcasticCarousel() {
  ...
  // Create many sets for truly infinite scroll
  const extendedCompanies = Array(20).fill(companies).flat();
        ...
        <CarouselContent className="-ml-2">
          {extendedCompanies.map((company, index) => (
            <CarouselItem 
              ...
              className="pl-2 basis-[300px]" // Fixed width for all items
            >
              <motion.div
                ...
                className="flex items-center justify-center h-24" // Fixed height container
              >
