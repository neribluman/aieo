                ...
                >
                  ...
                  <div className="p-3 border-t border-gray-200 bg-gray-50">
                    <Grid numItems={2} className="gap-2">
                      <Flex>
                        <div>
                          <Text className="text-sm text-gray-600">Ranked in</Text>
                          <Text className="font-medium">{engine.percentageRanked}%</Text>
                        </div>
                        <div>
                          <Text className="text-sm text-gray-600">Avg Position</Text>
                      ...
                      <Flex>
                        ...
                        <div>
                          <Text className="text-sm text-gray-600">Avg Citation Pos</Text>
