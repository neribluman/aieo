        ...
        "(min-width: 1024px)": () => {
          ...
          const tl = gsap.timeline({
            scrollTrigger: {
              ...
              onEnter: () => {
                // Ensure first section is visible when entering
                gsap.to(panels[0], { opacity: 1, duration: 0.5 });
              }
            }
          });
          ...
          panels.forEach((panel, i) => {
            ...
            const texts = panel.querySelectorAll("h2, p, div");
            
            // Fade in panel when it enters viewport
            gsap.from(panel, {
              opacity: 0,
              scrollTrigger: {
                trigger: panel,
