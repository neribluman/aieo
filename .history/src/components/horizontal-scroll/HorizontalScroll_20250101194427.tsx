  ...
  useEffect(() => {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        onLeave: () => {
          // Ensure smooth transition when leaving horizontal scroll
          gsap.to(container, {
            opacity: 1,
            duration: 0.1,
            onComplete: () => {
        ...
        onLeaveBack: () => {
          // Ensure smooth transition when scrolling back up
          gsap.to(container, {
            opacity: 1,
            duration: 0.1,
            onComplete: () => {
    ...
    const handleResize = () => {
      ...
      resizeTimeout = setTimeout(() => {
        ScrollTrigger.refresh(true); // Force refresh on resize
      }, 250);
    };
