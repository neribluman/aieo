  ...
  const getCompetitorsForICP = (profile: string): { name: string; score: number }[] => {
    const competitorsByProfile: { [key: string]: { name: string; score: number }[] } = {
      'Enterprise DevOps Teams': [
        { name: 'Redgate', score: 42 },
        { name: 'Ariga.io', score: 38 },
        { name: 'PlanetScale', score: 35 },
        { name: 'Hasura', score: 32 },
        { name: 'Atlas', score: 28 }
      ],
      'Cloud-Native Startups': [
        { name: 'Ariga.io', score: 45 },
        { name: 'PlanetScale', score: 42 },
        { name: 'Hasura', score: 38 },
        { name: 'Atlas', score: 35 },
        { name: 'Redgate', score: 30 }
      ],
      'Financial Services': [
        { name: 'Redgate', score: 35 },
        { name: 'Atlas', score: 32 },
        { name: 'PlanetScale', score: 28 },
        { name: 'Ariga.io', score: 25 },
        { name: 'Hasura', score: 22 }
      ],
      'SaaS Providers': [
        { name: 'PlanetScale', score: 48 },
        { name: 'Hasura', score: 45 },
        { name: 'Ariga.io', score: 42 },
        { name: 'Atlas', score: 38 },
        { name: 'Redgate', score: 35 }
      ]
    };
