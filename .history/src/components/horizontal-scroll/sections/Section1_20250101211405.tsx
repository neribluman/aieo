      ...
      <div className="max-w-7xl mx-auto w-full relative">
        ...
        >
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            >
              Understand how AI systems perceive and interact with your product in the digital landscape.
            </motion.p>
...
const features = [
  { label: "AI Perception Analysis" },
  { label: "Digital Presence Mapping" },
