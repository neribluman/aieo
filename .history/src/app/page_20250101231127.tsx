            ...
            >
              ...
              >
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-geist-sans font-light tracking-tight text-gray-900">
                  Shape how
                  <motion.span 
                    className="block mt-2 mb-6 font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                <motion.p 
                  className="text-xl md:text-2xl text-gray-500 font-light mt-12"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
