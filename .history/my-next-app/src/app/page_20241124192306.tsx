            ...
            <Card className="bg-white/50 backdrop-blur-sm shadow-glow h-full">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-3">
                  <Badge style={{ backgroundColor: '#6366F1' }}>Ranking Score</Badge>
                  <Badge style={{ backgroundColor: '#10B981' }}>Citation Score</Badge>
                  <Badge style={{ backgroundColor: '#F59E0B' }}>Competition Score</Badge>
                </div>
              </div>
