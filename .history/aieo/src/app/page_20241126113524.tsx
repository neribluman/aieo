...
export default function VisibilityDashboard() {
  ...
  const monthlyScores = [
    ...
    { 
      ...
      citationAppearance: 189,
      avgCitationPosition: 3.5,
    },
    { 
      month: 'Jul 2024',
      percentageRanked: 82,
      avgRankingPosition: 2.7,
      citationAppearance: 145,
    ...
    { 
      ...
      avgCitationPosition: 3.0,
    },
    { 
      month: 'Sep 2024',
      percentageRanked: 88,
      avgRankingPosition: 2.3,
      citationAppearance: 223,
    ...
    { 
      ...
      citationAppearance: 198,
      avgCitationPosition: 2.5,
    },
  ];
            ...
            <Card className="bg-white/50 backdrop-blur-sm shadow-glow h-full">
              ...
              <AreaChart
                ...
                valueFormatter={(value: number, category: string) => {
                  if (category === "citationAppearance") return `${value}`;
                  if (category === "percentageRanked") return `${value}%`;
                    ...
                    <div className="p-2 bg-white/90 border border-gray-200 rounded-lg shadow-lg">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">Ranked: {payload[0].payload.percentageRanked}%</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-emerald-500" />
                          <span className="text-sm">Avg Position: #{payload[0].payload.avgRankingPosition.toFixed(1)}</span>
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">Avg Citation: #{payload[0].payload.avgCitationPosition.toFixed(1)}</span>
                        </div>
                      </div>
                    </div>
                  );
