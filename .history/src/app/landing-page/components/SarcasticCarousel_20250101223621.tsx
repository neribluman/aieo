...
export function SarcasticCarousel() {
  ...
  // Create three sets of companies for smooth infinite scroll
  const extendedCompanies = [...mockCompanies, ...mockCompanies, ...mockCompanies];
        ...
        <div className="flex backface-hidden touch-pan-y justify-center items-center">
          {extendedCompanies.map((company, index) => (
            <div 
              ...
              className="relative flex-[0_0_auto] min-w-0 px-8 md:px-12"
              style={{ 
