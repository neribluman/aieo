            ...
            >
              <table className="w-full">
                <thead className="sticky top-0 bg-white z-10">
                  <tr>
                    <th className="w-1/2 p-3 text-left font-medium text-gray-700 border-b border-gray-200">
                      Query
                    </th>
                    {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => (
                      <th key={platform} className="w-[10%] p-3 text-center font-medium text-gray-700 border-b border-gray-200">
                        {platform}
                      </th>
                    ))}
                  </tr>
                  ...
                  {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                    ...
                    return (
                      <tr
                        ...
                        className="group hover:bg-blue-50 transition-colors relative"
                        style={{
                      ...
                      >
                        <td className="p-3 border-b border-gray-200">
                          <div className="space-y-2">
                            <Text className="font-medium text-gray-900">{query.query}</Text>
                        ...
                        {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => {
                          ...
                          return (
                            <td key={platform} className="p-3 text-center border-b border-gray-200">
                        ...
                        {/* Hover Analysis Card */}
                        <div className="absolute hidden group-hover:block z-20 left-0 top-full mt-2 w-[600px] p-4 bg-white rounded-lg shadow-xl border border-gray-200">
