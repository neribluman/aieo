...
export function HorizontalScroll({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Set container height to exactly match horizontal scroll
    gsap.set(container, {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        onLeaveBack: function() {
          // When scrolling back up to horizontal section
          ScrollTrigger.refresh();
        },
        onLeave: function() {
          // When leaving horizontal section to Section4
          ScrollTrigger.refresh();
        }
      }
    });
