  ...
  const personas = [
    {
      id: 'devops-lead',
      title: 'DevOps Lead',
      name: 'DevOps Lead', // Add this for consistency
      metrics: [
        { label: 'Average Sentiment', value: 48, trend: '+18%' },
    ...
    },
    {
      ...
      name: 'Database Architect', // Add this for consistency
      metrics: [
        { label: 'Average Sentiment', value: 45, trend: '+15%' },
        { label: 'Average Position', value: 2.5, trend: '+1.5' },
    ...
    },
    {
      id: 'tech-lead',
      title: 'Tech Lead',
      name: 'Tech Lead', // Add this for consistency
      metrics: [
          ...
          <div className="space-y-6">
            <Card className="bg-white p-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Top Markets on the right */}
                <div className="bg-gray-50 rounded-lg p-4">
                  <Text className="font-medium mb-3">Top Markets</Text>
                  <div className="space-y-2">
          ...
          <div className="space-y-6">
            <Card className="bg-white p-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Top Competitors on the right */}
                <div className="bg-gray-50 rounded-lg p-4">
                  <Text className="font-medium mb-3">Top Competitors</Text>
                  <div className="space-y-2">
                    {activeNode.details.topCompetitors?.map((competitor) => (
          ...
          <div className="space-y-6">
            <Card className="bg-white p-6">
              ...
              <div className="space-y-4">
                {queries
                  .filter(q => {
                    // Filter queries based on persona
                  ...
                  .map((query) => (
                    <div key={query.id} className="bg-gray-50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge color={
                          query.impact === 'High' ? 'green' :
                          query.impact === 'Medium' ? 'yellow' : 'red'
                        }>
                          {query.impact} Impact
                        </Badge>
                      </div>
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
              <div className="flex justify-between items-center">
                <div>
                  <Text className="text-sm text-gray-600">Decision Influence</Text>
                  <Text className="font-medium">{persona.details.influence}%</Text>
                </div>
                <ChevronRightIcon className="w-5 h-5 text-gray-400" />
              </div>
            </div>
  ...
  const competitorData: CompetitorData[] = [
    {
      ...
      topSources: [
        {
          headline: "Best Practices for Database Schema Management in 2024",
          link: "https://www.infoq.com/articles/database-schema-management-2024",
          platforms: [
            { name: "Claude", citationCount: 12, citationPercentage: 3.2 },
            { name: "Perplexity", citationCount: 8, citationPercentage: 2.1 },
            { name: "Gemini", citationCount: 5, citationPercentage: 1.3 }
          ],
          totalCitations: 25
        },
        {
          headline: "Database DevOps: The Complete Guide to Schema Automation",
          link: "https://devops.com/database-schema-automation-guide",
          platforms: [
            { name: "Perplexity", citationCount: 15, citationPercentage: 4.0 },
            { name: "Claude", citationCount: 10, citationPercentage: 2.7 },
            { name: "SearchGPT", citationCount: 6, citationPercentage: 1.6 }
          ],
          totalCitations: 31
        },
        {
          headline: "How Redgate Simplifies Database Change Management",
          link: "https://thenewstack.io/database-change-management",
          platforms: [
            { name: "Claude", citationCount: 9, citationPercentage: 2.4 },
            { name: "Gemini", citationCount: 7, citationPercentage: 1.9 },
            { name: "Perplexity", citationCount: 5, citationPercentage: 1.3 }
          ],
          totalCitations: 21
        }
      ]
    },
    {
      ...
      topSources: [
        {
          headline: "GraphQL and Database Schema Management with Hasura",
          link: "https://thenewstack.io/graphql-database-schema-hasura",
          platforms: [
            { name: "Claude", citationCount: 14, citationPercentage: 3.8 },
            { name: "Perplexity", citationCount: 11, citationPercentage: 2.9 },
            { name: "Gemini", citationCount: 7, citationPercentage: 1.8 }
          ],
          totalCitations: 32
        },
        {
          headline: "Modern Database Development: Hasura's Approach to Schema Management",
          link: "https://www.infoq.com/articles/hasura-schema-management",
          platforms: [
            { name: "Perplexity", citationCount: 13, citationPercentage: 3.4 },
            { name: "Claude", citationCount: 9, citationPercentage: 2.4 },
            { name: "SearchGPT", citationCount: 5, citationPercentage: 1.3 }
          ],
          totalCitations: 27
        },
        {
          headline: "Automating Database Operations with Hasura's Schema Tools",
          link: "https://devops.com/hasura-schema-automation",
          platforms: [
            { name: "Gemini", citationCount: 10, citationPercentage: 2.6 },
            { name: "Claude", citationCount: 8, citationPercentage: 2.1 },
            { name: "Perplexity", citationCount: 6, citationPercentage: 1.6 }
          ],
          totalCitations: 24
        }
      ]
    },
    {
      ...
      topSources: [
        {
          headline: "PlanetScale's Revolutionary Approach to Database Schema Changes",
          link: "https://techcrunch.com/planetscale-schema-management",
          platforms: [
            { name: "Perplexity", citationCount: 16, citationPercentage: 4.2 },
            { name: "Claude", citationCount: 12, citationPercentage: 3.2 },
            { name: "Gemini", citationCount: 8, citationPercentage: 2.1 }
          ],
          totalCitations: 36
        },
        {
          headline: "Database Branching and Schema Management in PlanetScale",
          link: "https://www.zdnet.com/article/planetscale-database-branching",
          platforms: [
            { name: "Claude", citationCount: 11, citationPercentage: 2.9 },
            { name: "Perplexity", citationCount: 9, citationPercentage: 2.4 },
            { name: "SearchGPT", citationCount: 6, citationPercentage: 1.6 }
          ],
          totalCitations: 26
        },
        {
          headline: "How PlanetScale Handles Large-Scale Database Schema Changes",
          link: "https://venturebeat.com/planetscale-schema-management",
          platforms: [
            { name: "Gemini", citationCount: 13, citationPercentage: 3.4 },
            { name: "Claude", citationCount: 10, citationPercentage: 2.6 },
            { name: "Perplexity", citationCount: 7, citationPercentage: 1.8 }
          ],
          totalCitations: 30
        }
      ]
          ...
          <div>
            <div className="bg-white rounded-lg p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <Badge color="blue">Top competitors ranked by visibility</Badge>
              </div>
                    ...
                    >
                      ...
                      <div className="p-4 border-t border-gray-200 bg-gray-50">
                        <div className="space-y-4">
                              ...
                              {competitor.topSources.map((source, idx) => (
                                <div key={idx} className="p-3 border rounded-lg hover:bg-gray-50">
                                  <div className="flex items-center justify-between mb-2">
                                    ...
                                    <Badge size="sm" color="blue">
                                      {source.totalCitations} citations
                                    </Badge>
                                  </div>
                                  <div className="grid grid-cols-3 gap-2 mt-2">
                                    {source.platforms.map((platform, pIdx) => (
                                      <div key={pIdx} className="flex items-center justify-between text-xs text-gray-600">
                                        ...
                                        <span>{platform.citationPercentage}%</span>
                                      </div>
                                    ))}
                                  </div>
                                </div>
                          ...
                          {/* Trend Analysis */}
                          <Card decoration="left" decorationColor="amber" className="bg-white/60">
