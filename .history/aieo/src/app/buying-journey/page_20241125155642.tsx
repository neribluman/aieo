                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex flex-col">
                        <div className="font-medium text-lg">
                          {stage.queryEvolution.totalQueries.toLocaleString()} queries
                        </div>
                        <div className="text-sm opacity-90">
                          {stage.queryEvolution.relevantQueries.toLocaleString()} relevant • {summary.metrics}
                        </div>
                      </div>
                      <div className="flex flex-col items-end">
                        <Badge 
                          color="blue" 
                          size="sm" 
                          className="bg-blue-500/80 hover:bg-blue-600/80 text-white transition-colors"
                        >
                          Click to explore →
                        </Badge>
                        <Text className="text-sm mt-1 opacity-80">
                    ...
                    <Card>
                      ...
                      <div className="mt-4">
                        <DonutChart
                          ...
                          showTooltip={true}
                          label={`${stage.sentiment.positive}% Positive`}
                        />
                        <Legend
