                  ...
                  >
                    ...
                    >
                      <span className="relative bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text">
                        ...
                        <motion.div
                          className="absolute -top-6 left-0 right-0 overflow-hidden h-4 opacity-30"
                          initial={{ opacity: 0 }}
                        >
                          {[..."01"].map((char, i) => (
                            <motion.span
                              key={i}
                              className="absolute text-sm text-purple-600"
                        ...
                        <motion.div
                          className="absolute -bottom-6 left-0 right-0 overflow-hidden h-4 opacity-30"
                          initial={{ opacity: 0 }}
                        >
                          {[..."10"].map((char, i) => (
                            <motion.span
