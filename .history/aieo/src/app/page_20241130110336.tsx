    ...
    <div className="p-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="bg-white border rounded-lg shadow-lg p-6">
              ...
              {topCitations.map((citation) => (
                <details 
                  key={citation.id} 
                  className="mt-4 group bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-200"
                >
                  <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50">
                    <div className="flex items-center gap-3">
                      ...
                      <Text className="font-medium">{citation.title}</Text>
                    </div>
                    <div className="flex items-center gap-2">
          ...
          <div className="space-y-4">
            <Card className="bg-white/50 backdrop-blur-sm p-6">
