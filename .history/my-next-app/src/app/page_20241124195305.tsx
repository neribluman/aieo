              ...
              <TabPanels>
                <TabPanel>
                  <div className="relative h-[400px] mt-4">
                    {/* Here you would integrate an actual globe visualization */}
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center text-gray-500">
                        <Text>Globe visualization would go here</Text>
                        <Text className="text-sm">Shows regional heat map of visibility scores</Text>
                      </div>
                    </div>
                  </div>
                </TabPanel>
