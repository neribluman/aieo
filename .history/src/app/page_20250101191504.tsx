...
export default function LandingPage() {
  ...
  return (
    <main className="relative">
      ...
      <section className="h-screen relative overflow-hidden bg-gradient-to-b from-white via-purple-50 to-white">
      ...
      <div ref={horizontalRef} className="relative bg-white">
        <div 
          ref={sectionsRef} 
          className="flex flex-nowrap"
        >
          {/* First Horizontal Section */}
          <section className="w-screen h-screen flex-shrink-0 bg-gradient-to-r from-purple-50 to-white p-8">
            <div className="max-w-4xl mx-auto h-full flex items-center">
              <div className="space-y-6">
                <h2 className="text-4xl font-light">
                  Discover the Power of
                  <span className="block font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text">
                    AI-Driven Insights
                  </span>
                </h2>
                <p className="text-xl text-gray-600">
                  Our advanced AI analyzes your product from every angle, providing deep insights into its market perception.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="w-screen h-screen flex-shrink-0 bg-gradient-to-r from-white to-purple-50 p-8">
            <div className="max-w-4xl mx-auto h-full flex items-center">
              <div className="space-y-6">
                <h2 className="text-4xl font-light">
                  Transform Data into
                ...
                <p className="text-xl text-gray-600">
                  Get detailed reports and recommendations to optimize your product's market position.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="w-screen h-screen flex-shrink-0 bg-gradient-to-r from-purple-50 to-white p-8">
            <div className="max-w-4xl mx-auto h-full flex items-center">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600">
                  Join thousands of businesses that have already transformed their approach with our AI insights.
                </p>
              </div>
            </div>
          </section>
