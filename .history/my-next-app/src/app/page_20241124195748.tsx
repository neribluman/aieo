                  ...
                  <div className="h-[500px] mt-4 relative">
                    <div className="absolute inset-0">
                      <WorldMap
                        ...
                        strokeOpacity={0.2}
                        strokeWidth={1}
                        tooltip={({ country, value }: { country: string, value: number }) => (
                          <div className="bg-white/95 p-3 rounded-lg shadow-lg border border-gray-200">
                            <Text className="font-medium">{country}</Text>
                            <div className="flex items-center gap-2 mt-1">
                              <Text className="text-sm">Visibility Score:</Text>
                              <Badge color={value > 40 ? "green" : value > 20 ? "yellow" : "orange"}>
                                {value}%
                              </Badge>
                            </div>
                          </div>
                        ...
                        styleFunction={(country, value) => {
                          if (value) {
                            const opacity = Math.max(0.1, value / 100); // minimum opacity of 0.1
                            return {
