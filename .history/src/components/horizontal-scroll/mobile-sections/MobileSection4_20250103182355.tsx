  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-lg mx-auto">
        ...
        {/* Citations - Horizontally Scrollable Cards */}
          ...
          {citations.map((citation, index) => (
            ...
            >
              <motion.div 
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-purple-100/20"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">{citation.description}</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
