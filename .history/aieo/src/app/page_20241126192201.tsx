                    ...
                    <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex gap-3 mt-1 text-sm text-gray-500">
                          ...
                          <span>•</span>
                          <span>{citation.metrics.totalQueryReferences.toLocaleString()} Views</span>
                        </div>
                      </div>
                      <svg 
                        ...
                        <Card decoration="left" decorationColor="blue" className="bg-white/50">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <Text className="text-sm text-gray-600 italic">"{citation.metrics.queryBreakdown.awareness / citation.metrics.totalQueryReferences * 100}% of queries about understanding schema migration"</Text>
                            </div>
                                ...
                                {citation.metrics.engineReferences.map(engine => (
                                  <div key={engine.platform} className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-1">
                                      <Text className="text-xs font-medium">{engine.references}</Text>
                              ...
                              <div className="space-y-2">
                                {citation.competitorMentions.map((competitor, idx) => (
                                  <div key={idx} className="flex items-center justify-between">
                                    ...
                                    <Text className="text-xs">{competitor.coMentionCount} mentions</Text>
                                  </div>
                                ))}
                              </div>
                            </div>
                        ...
                        <Card decoration="left" decorationColor="blue" className="bg-white/50">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <Text className="font-medium">{citation.source.type}</Text>
                            </div>

                            <div>
                              <Text className="text-xs text-gray-500">Reach</Text>
                              <Text className="font-medium">{citation.metrics.totalQueryReferences.toLocaleString()} Views</Text>
                            </div>
