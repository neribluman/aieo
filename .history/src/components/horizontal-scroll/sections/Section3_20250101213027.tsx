    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative">
        ...
        >
          ...
          >
            <div className="w-full bg-white rounded-xl shadow-2xl hover:shadow-3xl transition-shadow duration-300">
              <img
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            >
              Master Every
              <span className="block mt-2 mb-3 leading-relaxed font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text">
                Buying Stage
              </span>
            </motion.h2>
