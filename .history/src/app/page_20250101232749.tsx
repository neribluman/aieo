            ...
            >
              ...
              >
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-geist-sans font-light tracking-tight text-gray-900 leading-[1.1]">
                  Shape how
                  <motion.span 
                    className="block mt-0 mb-2 font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text leading-[1.1] py-1 relative"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    >
                      <span className="relative bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text">
                        AI Engines
                        {/* Circuit lines */}
                        <motion.span 
                          className="absolute -top-1 -left-1 w-8 h-[2px] bg-gradient-to-r from-purple-500/0 via-purple-500/50 to-purple-500/0"
                          animate={{
                            opacity: [0, 1, 0],
                            x: [-10, 100, 200],
                          }}
                        ...
                        />
                        <motion.span 
                          className="absolute -bottom-1 -right-1 w-8 h-[2px] bg-gradient-to-r from-purple-500/0 via-purple-500/50 to-purple-500/0"
                          animate={{
                            opacity: [0, 1, 0],
                            x: [200, -10, -100],
                          }}
                        ...
                        />
                        <motion.span 
                          className="absolute -right-1 top-0 w-[2px] h-8 bg-gradient-to-b from-purple-500/0 via-purple-500/50 to-purple-500/0"
                          animate={{
                            opacity: [0, 1, 0],
                            y: [-10, 20, 50],
                          }}
                        ...
                        {/* Glow effect */}
                        <motion.span 
                          className="absolute inset-0 -z-10 blur-[2px] bg-purple-500/20 rounded-lg"
                          animate={{
                            opacity: [0.1, 0.3, 0.1],
                          }}
                          transition={{
                ...
                >
                  <Link 
                    href="/pricing"
                    className="text-[#2E0854] hover:text-[#9400D3] transition-colors duration-200 flex items-center gap-2 text-lg"
                  >
