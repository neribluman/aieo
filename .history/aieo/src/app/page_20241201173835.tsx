                  ...
                  {queries
                    .filter((q: QueryPerformance) => {
                      switch (activeNode.name) {
                        case 'DevOps Lead':
                          return personaQueries['DevOps Lead'].map(pq => pq.id).includes(q.id);
                        case 'Database Architect':
                          return personaQueries['Database Architect'].map(pq => pq.id).includes(q.id);
                        case 'Tech Lead':
                          return personaQueries['Tech Lead'].map(pq => pq.id).includes(q.id);
                        default:
                          return true;
                      }
                    })
