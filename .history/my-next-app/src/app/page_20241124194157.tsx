  ...
  const sampleQueries = [
    {
      ...
      query: "database schema management challenges teams face",
      platforms: [
    ...
    {
      category: "Research",
      query: "database schema management tools comparison",
      platforms: [
    ...
    },
    {
      ...
      query: "Ariga vs other schema management vendors",
      platforms: [
    ...
    },
    {
      ...
      query: "how does Ariga handle complex schema migrations",
      platforms: [
    ...
    },
    {
      ...
      query: "Ariga schema management ROI and implementation timeline",
      platforms: [
