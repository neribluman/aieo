              ...
              {aiEngineRankings.map((engine) => (
                <div key={engine.engine} className="p-4 rounded-lg bg-gradient-to-r from-white to-gray-50">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Badge color={engine.color}>{engine.visibility}% Visibility</Badge>
                  </div>
                  ...
                  <Grid numItems={2} numItemsSm={2} numItemsLg={2} className="gap-2">
                    <Card decoration="top" decorationColor={engine.color} className="bg-white/80">
                      <Flex>
                        <div>
                          <Text className="text-sm">Ranked in</Text>
                          <Text className="font-medium">{engine.percentageRanked}%</Text>
                        </div>
                        <div>
                          <Text className="text-sm">Avg Position</Text>
                    ...
                    <Card decoration="top" decorationColor={engine.color} className="bg-white/80">
                      <Flex>
                        <div>
                          <Text className="text-sm">Citations</Text>
                          <Text className="font-medium">{engine.citationAppearance}</Text>
                        </div>
                        <div>
                          <Text className="text-sm">Avg Citation Pos</Text>
                          <Text className="font-medium">#{engine.avgCitationPosition.toFixed(1)}</Text>
                        </div>
                      </Flex>
                    </Card>
                  </Grid>
