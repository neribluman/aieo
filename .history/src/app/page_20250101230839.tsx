            ...
            >
              ...
              >
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-geist-sans font-light tracking-tight text-gray-900">
                  Right now,
                  <motion.span 
                    className="block mt-2 mb-4 font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  >
                    Uncover the truth <ArrowRight className="w-5 h-5" />
                  </Link>
                </motion.div>
              </motion.div>
