                ...
                >
                  ...
                  <div className="p-4 border-t border-gray-200 bg-gray-50">
                    <Grid numItems={2} className="gap-4">
                      <Card decoration="top" decorationColor={engine.color} className="bg-white">
                        <Title className="text-sm mb-4">Ranking Performance</Title>
                        <Grid numItems={2} className="gap-4">
                          <div className="text-center">
                            <Text className="text-xs text-gray-500 mb-1">Content Ranked</Text>
                            <Badge size="xl" color={engine.color}>
                              {engine.percentageRanked}%
                            </Badge>
                          </div>
                          <div className="text-center">
                            <Text className="text-xs text-gray-500 mb-1">Average Position</Text>
                            <Badge size="xl" color={engine.color}>
                      ...
                      <Card decoration="top" decorationColor={engine.color} className="bg-white">
                        <Title className="text-sm mb-4">Citation Performance</Title>
                        <Grid numItems={2} className="gap-4">
                          <div className="text-center">
                            <Text className="text-xs text-gray-500 mb-1">Total Citations</Text>
                            <Badge size="xl" color={engine.color}>
