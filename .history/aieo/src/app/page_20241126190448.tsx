...
export default function VisibilityDashboard() {
  ...
  const topCitations: Citation[] = [
    {
      id: '1',
      title: 'Best Database Schema Management Tools in 2024',
      url: 'https://perplexity.ai/c/123',
      platform: 'Perplexity',
      date: '2024-02-15',
      citationType: 'Review',
      context: 'Ariga.io stands out with its innovative approach to schema management, particularly in handling complex migrations.',
      sentiment: 'Positive',
      reach: 15000,
      otherCompanies: [
        { name: 'Redgate', sentiment: 'Positive' },
        { name: 'Atlas', sentiment: 'Neutral' },
        { name: 'Hasura', sentiment: 'Positive' }
      ],
      attention: {
        type: 'Opportunity',
        message: 'High engagement on migration features - consider expanding content'
      }
    },
    // ... add more citations (I can provide more examples if needed)
  ];
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                  <Badge color="emerald">20 Active Citations</Badge>
                  <Badge color="blue">85% Positive Sentiment</Badge>
                </div>
              </div>
