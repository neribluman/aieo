                    ...
                    <span className="relative">
                      ...
                      <motion.span
                        ...
                        animate={{
                          ...
                          opacity: [0, 0.8, 0],
                          background: [
                            "linear-gradient(to right, #2E0854, #9400D3)",
                            "linear-gradient(to right, #9400D3, #2E0854)",
                            "linear-gradient(to right, #2E0854, #9400D3)",
                          ],
                        }}
                        transition={{
                      ...
                      <motion.span
                        className="absolute inset-0 bg-gradient-to-r from-[#9400D3] to-[#2E0854] text-transparent bg-clip-text"
                        animate={{
                          x: [0, 2, 0, -2, 0],
                          opacity: [0, 0.8, 0],
                          background: [
