  ...
  const sampleQueries = [
    ...
    },
    {
      ...
      platforms: [
        ...
        { name: "MetaAI", position: 4, cited: false }
      ],
      impact: "Medium",
                  ...
                  <Table className="mt-4">
                    ...
                    <TableBody>
                      {sampleQueries.map((query) => {
                        const bestPosition = Math.min(...query.platforms.map(p => p.position));
                        ...
                        return (
                          <TableRow key={query.query}>
                            ...
                            <TableCell>
                              <Badge color={bestPosition <= 2 ? "green" : "yellow"}>
                                #{bestPosition}
                              </Badge>
                            </TableCell>
                            <TableCell>
                      ...
                      {sampleQueries.flatMap((query) =>
                        query.platforms.map((platform, idx) => (
                          <TableRow key={`${query.query}-${platform.name}`}>
                            ...
                            <TableCell>
                              <Badge color={platform.position <= 2 ? "green" : "yellow"}>
                                #{platform.position}
                              </Badge>
                            </TableCell>
                            <TableCell>
