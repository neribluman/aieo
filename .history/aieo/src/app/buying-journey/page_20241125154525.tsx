    ...
    <div className="space-y-4">
      {data.map((stage, index) => (
        ...
        >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-[200px] text-left">
                ...
                <Text className="text-sm text-gray-600">
                  AI Readiness: {stage.aiReadiness.score}%
                </Text>
              </div>
              
              {/* Funnel bar */}
              <div
                className={`h-20 bg-gradient-to-r ${getStageGradient(stage, index)} rounded-lg relative 
                           transition-all duration-300 hover:scale-[1.02] hover:shadow-lg flex-grow`}
                style={{
                  width: `${(stage.customers / data[0].customers) * 100}%`
                }}
              >
                <div className="absolute inset-0 flex items-center justify-end px-4 text-white">
                  <div className="text-right">
                    <div className="font-medium">{stage.customers} users</div>
                    <div className="text-sm opacity-90">
                      {stage.queryEvolution.relevantQueries} relevant queries
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Update the AI Platform Responses section */}
          <AnimatePresence>
            {selectedStage === stage.stage && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Card>
                    <Title>Sentiment Breakdown</Title>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-grow bg-gray-200 rounded-full h-2">
                            <div
                              ...
                              style={{ width: `${stage.sentiment.positive}%` }}
                            />
                          </div>
                          <Text>{stage.sentiment.positive}%</Text>
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-grow bg-gray-200 rounded-full h-2">
                            <div
                              ...
                              style={{ width: `${stage.sentiment.neutral}%` }}
                            />
                          </div>
                          <Text>{stage.sentiment.neutral}%</Text>
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-grow bg-gray-200 rounded-full h-2">
                            <div
                              ...
                              style={{ width: `${stage.sentiment.negative}%` }}
                            />
                          </div>
                          <Text>{stage.sentiment.negative}%</Text>
                        </div>
                      </div>
                    </div>
                  </Card>
