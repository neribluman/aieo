...
import { ArrowRight, Loader2, Zap, BarChart, Brain } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto w-full relative">
        ...
        >
          ...
          <div className="text-center space-y-6">
            ...
            >
              Analyze your company's AI presence instantly
            </motion.p>
          </div>
...
const features = [
  {
    ...
    description: "Get immediate insights about your product's AI presence",
