...
function BuyingJourneyFunnel() {
  ...
  const JourneyMap = ({ path, onNodeClick }) => {
    ...
    const handleOptionClick = (level: string, option: string) => {
      ...
      // If clicking within the current active node, add to path
      ...
      // If clicking in a previous node, trim path and add new selection
      else if (path.length > currentLevelIndex) {
        const newPath = [
          ...path.slice(0, currentLevelIndex),
          { 
            id: option.toLowerCase().replace(/\s+/g, '-'), 
            name: option, 
            level 
      ...
      // If clicking ahead (shouldn't happen with proper UI), just add to current path
      else {
        const newPath = [
          ...path,
          { 
      ...
      <div className="bg-gradient-to-br from-gray-50 via-white to-blue-50/20 backdrop-blur-sm rounded-xl p-4 mb-6 shadow-sm">
        <div className="flex items-start gap-6 overflow-x-auto pb-2">
          ...
          <JourneyNode
            ...
            options={path.length === 1 ? getNodeData('vertical').options : undefined} // Show options when region is selected
          ...
          <JourneyNode
            ...
            options={path.length === 2 ? getNodeData('persona').options : undefined} // Show options when vertical is selected
          ...
          <JourneyNode
            ...
            options={path.length === 3 ? getNodeData('queries').options : undefined} // Show options when persona is selected
          ...
          <JourneyNode
            ...
            options={path.length === 4 ? getNodeData('queryDetails').options : undefined} // Show options when query is selected
