          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 border-t border-gray-200">
            <Card decoration="top" decorationColor="blue">
              ...
              <Text className="text-sm text-gray-500 mt-2">
                Sentiment score across all AI engines. Lower than previous month (-8%)
              </Text>
            </Card>
            ...
            <Card decoration="top" decorationColor="emerald">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge color="green">Good Trend ⭐</Badge>
              </div>
              <Metric className="text-emerald-600">
                #{aiEngineTimeSeries[aiEngineTimeSeries.length - 5].avgPosition.toFixed(1)}
              </Metric>
              <Text className="text-sm text-gray-500 mt-2">
                Average ranking position in search results. Improved by 0.4 positions
              </Text>
            </Card>
            ...
            <Card decoration="top" decorationColor="violet">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge color="yellow">Monitor Closely 📊</Badge>
              </div>
              <Metric className="text-violet-600">
                {aiEngineTimeSeries[aiEngineTimeSeries.length - 5].visibilityRate}%
              </Metric>
              <Text className="text-sm text-gray-500 mt-2">
                Frequency of company mentions. Stable but room for improvement
              </Text>
            </Card>
