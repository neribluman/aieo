    ...
    <div
      className={`
        ...
        ${isActive ? 
          ...
          isFuture ? 
            'bg-gradient-to-br from-gray-50/50 to-white border-gray-100' :
...
const JourneyMap = ({ path }: { path: BreadcrumbItem[] }) => {
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-blue-50/20 backdrop-blur-sm rounded-xl p-4 mb-6 shadow-sm">
      <div className="flex items-start gap-6 overflow-x-auto pb-2">
        ...
        <JourneyNode
          ...
          optionCount={3} // Enterprise Software, Financial Services, Healthcare Tech
          metric={{ value: 38 }}
        ...
        <JourneyNode
          ...
          optionCount={3} // DevOps Lead, Database Architect, Tech Lead
          metric={{ value: 35 }}
        ...
        <JourneyNode
          ...
          optionCount={3} // Schema migration tools, Database version control, CI/CD integration
          metric={{ value: 32 }}
