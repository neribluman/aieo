      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex backface-hidden touch-pan-y">
          {[...mockCompanies, ...mockCompanies].map((company, index) => (
            <div 
              key={index} 
              className="relative flex-[0_0_100%] min-w-0 pl-2 md:flex-[0_0_33.333%] lg:flex-[0_0_25%]"
              style={{ 
                  ...
                  <CardContent className="relative aspect-[4/3] p-0">
                    <div className="absolute inset-0 overflow-hidden">
                      <Image
                        ...
                        alt={company.name}
                        fill
                        className="object-contain opacity-40 transition-all duration-300 group-hover:opacity-60"
                        priority={index < 2}
                      />
                    </div>
                  </CardContent>
