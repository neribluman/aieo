                ...
                .map((competitor, index) => (
                  ...
                  >
                    <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50">
                      ...
                      <div className="flex items-center gap-3">
                        <Text className="font-medium">Score: {competitor.overallScore}%</Text>
                        <svg 
                          className="w-5 h-5 text-gray-500 group-open:rotate-180 transition-transform" 
                          fill="none" 
                          viewBox="0 0 24 24" 
                    ...
                    <Grid numItems={2} className="gap-4">
                      ...
                      <Card decoration="left" decorationColor={icp.color} className="bg-white/50">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between items-center">
                            <Text className="text-xs text-gray-500">Average Citations</Text>
                            <Text className="font-medium">{icp.avgCitations}</Text>
                          </div>
                        </div>
                      </Card>
                    </Grid>
