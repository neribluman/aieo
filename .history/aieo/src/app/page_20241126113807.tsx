...
export default function VisibilityDashboard() {
  ...
  const monthlyScores = [
    { 
      ...
      citationAppearance: 156 / 2,
      avgCitationPosition: 3.8 * 10,
    },
    { 
      month: 'Jun 2024',
      percentageRanked: 78,
      avgRankingPosition: 2.9 * 10,
      citationAppearance: 189 / 2,
      avgCitationPosition: 3.5 * 10,
    },
    { 
      month: 'Jul 2024',
      percentageRanked: 82,
      avgRankingPosition: 2.7 * 10,
      citationAppearance: 145 / 2,
      avgCitationPosition: 3.2 * 10,
    },
    { 
      month: 'Aug 2024',
      percentageRanked: 85,
      avgRankingPosition: 2.5 * 10,
      citationAppearance: 134 / 2,
      avgCitationPosition: 3.0 * 10,
    },
    { 
      month: 'Sep 2024',
      percentageRanked: 88,
      avgRankingPosition: 2.3 * 10,
      citationAppearance: 223 / 2,
      avgCitationPosition: 2.8 * 10,
    },
    { 
      month: 'Oct 2024',
      percentageRanked: 92,
      avgRankingPosition: 2.1 * 10,
      citationAppearance: 198 / 2,
      avgCitationPosition: 2.5 * 10,
    },
  ];
  ...
  const aiEngineRankings = [
    ...
    { 
      ...
      citationAppearance: 89,
      avgCitationPosition: 4.1,
      color: 'emerald'
    },
    { 
      engine: 'Gemini',
      visibility: 38,
      percentageRanked: 78,
      avgRankingPosition: 3.1,
      citationAppearance: 96,
    ...
    { 
      ...
      visibility: 36,
      percentageRanked: 80,
      avgRankingPosition: 2.9,
      citationAppearance: 98,
                    ...
                    <div className="p-2 bg-white/90 border border-gray-200 rounded-lg shadow-lg">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">Citations: {Math.round(payload[0].payload.citationAppearance * 2)}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-violet-500" />
                          <span className="text-sm">Avg Citation: #{(payload[0].payload.avgCitationPosition / 10).toFixed(1)}</span>
                        </div>
                      </div>
                    </div>
                  );
