                    ...
                    <div className="p-2 bg-white/90 border border-gray-200 rounded-lg shadow-lg">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">Company Mentioned: {payload[0].payload.companyMentioned}%</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-emerald-500" />
                          <span className="text-sm">Recommendation Probability: {payload[0].payload.recommendationProbability}%</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-amber-500" />
                          <span className="text-sm">Average Ranking: #{payload[0].payload.averageRanking.toFixed(1)}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-violet-500" />
                          <span className="text-sm">Citation Appearances: {payload[0].payload.citationAppearances}%</span>
                        </div>
                      </div>
                    </div>
                  );
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                <Card decoration="top" decorationColor="blue">
                  ...
                  <Metric className="text-blue-600">
                    {monthlyScores[monthlyScores.length - 1].companyMentioned}%
                  </Metric>
                ...
                <Card decoration="top" decorationColor="emerald">
                  ...
                  <Metric className="text-emerald-600">
                    {monthlyScores[monthlyScores.length - 1].recommendationProbability}%
                  </Metric>
                  <Text className="text-sm text-gray-500">Recommendation probability</Text>
                </Card>
                
                <Card decoration="top" decorationColor="amber">
                  <Text>Average Position</Text>
                  <Metric className="text-amber-600">
                    #{monthlyScores[monthlyScores.length - 1].averageRanking.toFixed(1)}
                  </Metric>
                ...
                >
                  ...
                  <div className="p-3 border-t border-gray-200 bg-gray-50">
                    <Grid numItems={2} className="gap-3">
                      <Card decoration="left" decorationColor={engine.color} className="bg-white/50">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            ...
                            <Text className="font-medium">{engine.visibility}%</Text>
                          </div>
                          <div className="flex justify-between items-center">
                            <Text className="text-xs text-gray-500">Recommendation Probability</Text>
                            <Text className="font-medium">{engine.percentageRanked}%</Text>
                          </div>
                          <div className="flex justify-between items-center">
                            <Text className="text-xs text-gray-500">Average Ranking</Text>
                            <Text className="font-medium">#{engine.avgRankingPosition.toFixed(1)}</Text>
                          </div>
                          <div className="flex justify-between items-center">
                            <Text className="text-xs text-gray-500">Citation Appearances</Text>
                            <Text className="font-medium">{engine.citationAppearance}%</Text>
                          </div>
                        </div>
                      </Card>
