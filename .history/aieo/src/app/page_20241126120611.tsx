        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <Card className="bg-white/50 backdrop-blur-sm p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <Title className="text-xl font-bold text-gray-900">AI Engine Performance</Title>
                <Text className="text-sm text-gray-500 mt-1">Comparative analysis across platforms</Text>
              </div>
            ...
            <div className="space-y-3">
              {aiEngineRankings.map((engine) => (
                <div 
                  key={engine.engine} 
                  className="p-4 rounded-lg bg-white border border-gray-100 hover:border-gray-200 transition-all duration-200 hover:shadow-sm"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 rounded-full bg-${engine.color}-500`} />
                      <Text className="font-semibold text-gray-900">{engine.engine}</Text>
                    </div>
