                  ...
                  {Object.entries(metricConfig).map(([key, config]) => (
                    <Tab 
                      ...
                      className={`
                        ...
                        ui-not-selected:bg-gray-50 ui-not-selected:text-gray-600
                        ui-selected:bg-blue-600 ui-selected:text-white
                        ui-selected:shadow-md ui-selected:scale-105
                        relative
                      `}
                    >
                      <div className="flex items-center gap-2">
                        {config.title}
                        <div className="ui-selected:block hidden w-2 h-2 rounded-full bg-white"></div>
                      </div>
                    </Tab>
                  ))}
                </TabList>
