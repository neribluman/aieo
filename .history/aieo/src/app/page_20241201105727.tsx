                  ...
                  {queries
                    ...
                    .map((query) => (
                      ...
                      >
                        ...
                        <div className="hover:bg-blue-50 p-2 cursor-pointer">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 flex-1">
                              <ChevronRightIcon className="w-4 h-4 text-gray-400 transform transition-transform group-data-[state=open]:rotate-90" />
