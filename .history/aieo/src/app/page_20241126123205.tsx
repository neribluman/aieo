            ...
            <div className="relative">
              <div className="sticky top-0 bg-white z-10 border-b border-gray-200">
                <div className="grid grid-cols-7 gap-2 px-4 py-3">
                  <div className="col-span-3 font-medium text-gray-700">Query</div>
                  {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => (
                    <div key={platform} className="text-center font-medium text-gray-700 text-sm">
                      {platform}
                    </div>
                  ))}
                </div>
                ...
                >
                  {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                    ...
                    return (
                      ...
                      >
                        <div className="group hover:bg-blue-50 transition-colors border-b border-gray-200">
                          <div className="grid grid-cols-7 gap-2 px-4 py-3">
