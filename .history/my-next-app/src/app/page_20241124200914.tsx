...
export default function VisibilityDashboard() {
  ...
  const citationLeaderboard = [
    { 
      ...
      analysis: {
        strengths: [
          "Dominant in TypeScript & Node.js ecosystem",
          "Top cited in ORM comparisons",
          "Strong developer community engagement"
        ],
        citationContext: "Most referenced in modern web development stacks",
        marketShare: "24%",
        recentUpdates: "Leading position in TypeScript database tooling"
      }
    },
    { 
      company: 'Liquibase', 
      ...
      analysis: {
        strengths: [
          "Enterprise database migration leader",
          "Strong Java ecosystem presence",
          "Extensive database platform support"
        ],
        citationContext: "Most cited in enterprise migration scenarios",
        marketShare: "22%",
        recentUpdates: "Enhanced cloud database support"
      }
    },
    { 
      company: 'Flyway', 
      ...
      analysis: {
        strengths: [
          "Popular in Spring ecosystem",
          "Simple migration workflow",
          "Strong version control integration"
        ],
        citationContext: "Highly referenced in Java development",
        marketShare: "19%",
        recentUpdates: "Improved cloud platform integration"
      }
    },
    { 
      company: 'Redgate', 
                      ...
                      <WorldMap
                        ...
                        styleFunction={(context: CountryContext<number>) => {
                          ...
                          const opacityLevel = calculatedValue 
                            ? 0.2 + (0.8 * (calculatedValue - context.minValue)) / (context.maxValue - context.minValue)
                            : 0.1;
