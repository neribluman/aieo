        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-500 mt-2">
              We've analyzed your product's AI visibility and prepared a detailed report. 
              Enter your work email to receive the full analysis.
            </DialogDescription>
          </DialogHeader>
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center px-6 py-3 
                         ...
                         shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30"
              >
                <span className="mr-2">Send Me the Analysis</span>
                <ArrowRight className="h-4 w-4" />
              </motion.button>
            </form>
          ) : (
            ...
            >
              ...
              <p className="text-gray-500">
                Check your inbox for the detailed visibility report.
              </p>
            </motion.div>
          )}
        </DialogContent>
