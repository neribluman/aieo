                    ...
                    return (
                      ...
                      >
                        <div className="group hover:bg-blue-50 transition-colors border-b border-gray-200">
                          ...
                          {/* Hover Analysis */}
                          <div className="hidden group-hover:block absolute left-0 top-full mt-2 w-[800px] p-6 bg-white rounded-lg shadow-xl border border-gray-200 z-20 backdrop-blur-md">
                            <div className="space-y-6">
                              ...
                              <div className="grid grid-cols-5 gap-4">
                                {platforms.map(platformName => {
                                  ...
                                  return (
                                    <div key={platformName} className="bg-gray-50 rounded-lg p-4">
