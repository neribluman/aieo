              ...
              <TableHead>
                <TableRow>
                  ...
                  {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => (
                    <TableHeaderCell key={platform}>{platform}</TableHeaderCell>
                  ))}
                </TableRow>
              </TableHead>
            </Table>
              ...
              >
                {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                  ...
                  return (
                    ...
                    >
                      <div 
                        className="group relative p-2 hover:bg-blue-50 transition-colors border-b border-gray-200"
                      >
                        <div className="grid grid-cols-6 gap-4">
                          <div className="truncate">
                            <Text className="font-medium truncate">{query.query}</Text>
                          </div>
                          {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => {
                        ...
                        {/* Hover Analysis Card */}
                        <div className="absolute hidden group-hover:block z-10 left-0 top-full mt-2 w-96 p-4 bg-white rounded-lg shadow-xl border border-gray-200">
                          <div className="space-y-3">
                            <div>
                              <Text className="font-medium">Query Analysis</Text>
                              <Text className="text-sm text-gray-600">{query.query}</Text>
                            </div>
                            <div className="grid grid-cols-2 gap-2 text-sm">
                              <div>
                                <Text className="font-medium">Category:</Text>
                                <Badge color="blue" size="sm">{query.category}</Badge>
                              </div>
                              <div>
                              ...
                              <div>
                                <Text className="font-medium">Intent:</Text>
                                <Badge color="violet" size="sm">{query.userIntent}</Badge>
                              </div>
                              <div>
                                <Text className="font-medium">Avg Position:</Text>
                                <Badge color="emerald" size="sm">#{query.averagePosition}</Badge>
                              </div>
                            </div>
                            <div>
