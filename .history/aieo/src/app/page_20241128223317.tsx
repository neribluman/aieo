...
import { ChevronRightIcon, ChevronLeftIcon, GlobeIcon, BuildingIcon, UserIcon, MapIcon } from '@heroicons/react/24/outline';
...
function BuyingJourneyFunnel() {
  ...
  const renderFunnelLevel = () => {
    ...
    // Render specific node details based on the current level
    return (
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6 mt-6">
            ...
            <Card decoration="left" decorationColor="emerald">
              ...
              <div className="space-y-4">
                {Object.entries(activeNode.details.performance).map(([key, value]: [string, number]) => (
                  <div key={key}>
        ...
        {/* Add next level (Industry Verticals) exploration section */}
        <Card>
          <Title className="mb-4">Industry Verticals</Title>
          <div className="grid grid-cols-3 gap-4">
            {/* Add vertical cards here */}
          </div>
        </Card>
      </div>
    );
