                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex flex-col min-w-[300px]">
                        <div className="flex items-baseline">
                          <div className="w-32 text-right font-medium text-lg tabular-nums">
                            {stage.queryEvolution.totalQueries.toLocaleString()}
                          </div>
                          <div className="ml-2">queries</div>
                        </div>
                        <div className="flex items-baseline">
                          <div className="w-32 text-right text-sm opacity-90 tabular-nums">
