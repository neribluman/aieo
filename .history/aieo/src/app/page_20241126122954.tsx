            ...
            <div className="relative">
              <div className="sticky top-0 bg-white z-10 border-b border-gray-200">
                <div className="grid grid-cols-6 gap-4 p-4">
                  <div className="col-span-2 font-medium text-gray-700">Query</div>
                  {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => (
                    <div key={platform} className="text-center font-medium text-gray-700">
                      {platform}
                    </div>
                  ))}
                </div>
                ...
                >
                  {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                    ...
                    return (
                      ...
                      >
                        <div className="group hover:bg-blue-50 transition-colors border-b border-gray-200 p-4">
                          <div className="grid grid-cols-6 gap-4">
                            ...
                            {['Perplexity', 'Claude', 'Gemini', 'SearchGPT', 'MetaAI'].map(platform => {
                              ...
                              return (
                                <div key={platform} className="flex justify-center items-center">
                                  <Badge 
                                  ...
                                  {platformData.cited && (
                                    <div className="w-2 h-2 rounded-full bg-green-500 ml-1" title="Cited"/>
                                  )}
                                </div>
                              );
                            })}
                          ...
                          {/* Hover Analysis */}
                          <div className="hidden group-hover:block absolute left-0 top-full mt-2 w-[600px] p-4 bg-white rounded-lg shadow-xl border border-gray-200 z-20">
                              ...
                              <div className="grid grid-cols-5 gap-4">
                                {query.platforms.map(platform => (
                                  <div key={platform.name} className="text-center p-2 rounded-lg bg-gray-50">
                                    <Text className="font-medium mb-2">{platform.name}</Text>
                                    <Badge 
                                    ...
                                    {platform.cited && (
                                      <Badge color="green" className="mt-2">Cited</Badge>
                                    )}
                                  </div>
                                ))}
                              </div>
