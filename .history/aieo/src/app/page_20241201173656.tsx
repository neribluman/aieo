                  ...
                  {queries
                    .filter(q => {
                      switch (activeNode.name) {
                        case 'DevOps Lead':
                          return personaQueries['DevOps Lead'].map(q => q.id).includes(q.id);
                        case 'Database Architect':
                          return personaQueries['Database Architect'].map(q => q.id).includes(q.id);
                        case 'Tech Lead':
                          return personaQueries['Tech Lead'].map(q => q.id).includes(q.id);
                        default:
                          return true;
                      }
                    })
