...
export default function VisibilityDashboard() {
  ...
  const getDetailedRankings = (position: Position): DetailedRanking[] => {
    // This is sample data - you should replace with real data
    const allCompanies = [
    ...
    // Generate some sample rankings around the position
    ...
    <div className="p-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <Card className="bg-white backdrop-blur-none">
                    ...
                    return (
                      ...
                      >
                        <div className="group hover:bg-blue-50 transition-colors border-b border-gray-200">
                          ...
                          {/* Hover Analysis */}
                          <div 
                            className="hidden group-hover:block absolute left-0 top-full mt-2 w-[800px] rounded-lg shadow-2xl border border-gray-200 z-20 bg-white"
                            style={{ 
                          ...
                          >
                            <div className="relative" style={{ backgroundColor: 'white' }}>
                              ...
                              <div className="space-y-6 p-6" style={{ backgroundColor: 'white' }}>
