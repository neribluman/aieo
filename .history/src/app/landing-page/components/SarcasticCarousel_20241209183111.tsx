...
export function SarcasticCarousel() {
  ...
  return (
    <div className="w-full px-0">
      ...
      >
        <h2 className="text-base md:text-lg font-light tracking-wide text-gray-500 italic">
          <span className="hidden md:inline">Those are companies who{" "}</span>
          <span className="hidden md:inline font-medium text-gray-600">don't know</span>
          <span className="hidden md:inline">{" "}what AI thinks about them</span>
          
          {/* Mobile version - single line */}
          <span className="md:hidden">
            Companies that need AI insights
          </span>
