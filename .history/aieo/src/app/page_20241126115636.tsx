                      ...
                      <div className="flex-1 max-w-[200px] relative">
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div 
                            ...
                            style={{ 
                              // Inverting the scale since lower position is better
                              // Assuming worst position is 10 and best is 1
                              width: `${((10 - engine.avgRankingPosition) / 9) * 100}%` 
                            }}
                          />
                        </div>
                        <Text className="absolute -top-5 right-0 text-xs text-gray-600">
                          Avg Position: #{engine.avgRankingPosition.toFixed(1)}
                        </Text>
                      </div>
                      <Badge color={engine.color}>
