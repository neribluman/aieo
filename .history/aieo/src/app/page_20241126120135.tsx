                ...
                <Card key={engine.engine} className="bg-white">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex gap-4">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500" />
                        <Text className="text-sm">Rank: #{engine.avgRankingPosition.toFixed(1)}</Text>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-emerald-500" />
                        <Text className="text-sm">Content: {engine.percentageRanked}%</Text>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-amber-500" />
                        <Text className="text-sm">Citations: {engine.citationAppearance}</Text>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-violet-500" />
                        <Text className="text-sm">Citation Pos: #{engine.avgCitationPosition.toFixed(1)}</Text>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-4 gap-2">
                    <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ 
                          width: `${((10 - engine.avgRankingPosition) / 9) * 100}%` 
                        }}
                      />
                    </div>
                    <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${engine.percentageRanked}%` }}
                      />
                    </div>
                    <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-amber-500 rounded-full"
                        style={{ width: `${(engine.citationAppearance / 40) * 100}%` }}
                      />
                    </div>
                    <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ 
                          width: `${((10 - engine.avgCitationPosition) / 9) * 100}%` 
                        }}
                      />
                    </div>
                  </div>
