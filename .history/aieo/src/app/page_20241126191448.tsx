...
export default function VisibilityDashboard() {
  ...
  const topCitations: Citation[] = [
    ...
    },
    {
      ...
      reach: 6200,
      otherCompanies: [
        { name: 'Flyway', sentiment: 'Neutral' },
        { name: 'DBmate', sentiment: 'Neutral' }
      ],
      attention: {
        type: 'Monitor',
    ...
    },
    {
      ...
      reach: 4800,
      otherCompanies: [
        { name: 'Redgate', sentiment: 'Positive' },
        { name: 'Liquibase', sentiment: 'Neutral' },
        { name: 'Flyway', sentiment: 'Neutral' }
      ],
      attention: {
        type: 'Risk',
    ...
    },
    {
      ...
      reach: 3500,
      otherCompanies: [
        { name: 'DBmaestro', sentiment: 'Neutral' },
        { name: 'Liquibase', sentiment: 'Neutral' }
      ],
      attention: null
    }
