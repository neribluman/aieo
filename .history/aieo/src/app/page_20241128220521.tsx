          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 border-t border-gray-200">
            <Card decoration="top" decorationColor="blue" className="p-3">
              ...
              <div className="mt-2 mb-1">
                <Metric className="text-blue-600 text-2xl">
            ...
            <Card decoration="top" decorationColor="emerald" className="p-3">
              ...
              <div className="mt-2 mb-1">
                <Metric className="text-emerald-600 text-2xl">
            ...
            <Card decoration="top" decorationColor="violet" className="p-3">
              ...
              <div className="mt-2 mb-1">
                <Metric className="text-violet-600 text-2xl">
            ...
            <Card decoration="top" decorationColor="amber" className="p-3">
              ...
              <div className="mt-2 mb-1">
                <Metric className="text-amber-600 text-2xl">
