...
interface FunnelNode {
  ...
  name: string;
  metrics: FunnelMetric[];
  details?: any; // Specific details for each node type
}
...
function BuyingJourneyFunnel() {
  ...
  const geographicRegions: FunnelLevel = {
    ...
    metrics: [
      { label: 'Global Visibility', value: '42%', trend: '+15%', color: 'emerald' },
      { label: 'Average Position', value: '#3.2', trend: '+0.8', color: 'blue' },
      { label: 'Citation Rate', value: '38%', trend: '+12%', color: 'violet' }
    ],
    children: [
      {
        id: 'americas',
        name: 'Americas',
        metrics: [
          { label: 'Regional Visibility', value: '48%', trend: '+18%' },
          { label: 'Market Share', value: '32%', trend: '+5%' },
          { label: 'Growth Rate', value: '+22%' }
        ],
        details: {
          topMarkets: ['USA', 'Canada', 'Brazil'],
          performance: { visibility: 48, engagement: 52, conversion: 35 }
        }
      },
      {
        id: 'emea',
        name: 'EMEA',
        metrics: [
          { label: 'Regional Visibility', value: '45%', trend: '+15%' },
          { label: 'Market Share', value: '28%', trend: '+7%' },
          { label: 'Growth Rate', value: '+18%' }
        ],
        details: {
          topMarkets: ['UK', 'Germany', 'France'],
          performance: { visibility: 45, engagement: 48, conversion: 32 }
        }
      },
      // Add more regions...
    ]
    ...
    const verticals = [
      {
        ...
        metrics: [
          { label: 'Market Share', value: '35%', trend: '+12%' },
          { label: 'Growth Rate', value: '28%', trend: '+15%' },
          { label: 'Engagement', value: '42%', trend: '+8%' }
        ]
      },
      {
        id: 'fintech',
        ...
        icon: <BuildingOfficeIcon className="w-6 h-6" />,
        metrics: [
          { label: 'Market Share', value: '32%', trend: '+10%' },
          { label: 'Growth Rate', value: '25%', trend: '+18%' },
          { label: 'Engagement', value: '38%', trend: '+5%' }
        ]
      },
      {
        id: 'healthcare',
        ...
        icon: <BuildingOfficeIcon className="w-6 h-6" />,
        metrics: [
          { label: 'Market Share', value: '28%', trend: '+15%' },
          { label: 'Growth Rate', value: '30%', trend: '+20%' },
          { label: 'Engagement', value: '35%', trend: '+12%' }
        ]
      }
    ];
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Card decoration="left" decorationColor="emerald" className="bg-white/50">
                ...
                <div className="space-y-4">
                  {Object.entries(activeNode.details.performance).map(([key, value]) => {
    ...
    if (currentLevel === 'vertical') {
      return (
        <div className="space-y-6">
          <Card>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <Title>{activeNode.name} Overview</Title>
              </div>
              <button
                onClick={() => {
                  setActiveNode(null);
          ...
          {/* Add Buyer Personas section */}
          <Card>
            <Title className="mb-4">Buyer Personas</Title>
            {/* I'll continue with the Buyer Personas implementation in the next update */}
          </Card>
        </div>
      );
    }
  ...
  // Add this to your BuyingJourneyFunnel component
    ...
    const personas = [
      {
        ...
        metrics: [
          { label: 'Visibility', value: '45%', trend: '+18%' },
          { label: 'Engagement', value: '38%', trend: '+12%' },
          { label: 'Intent', value: 'High', trend: '+25%' }
        ],
        details: {
          influence: 85,
          responsibilities: [
      ...
      },
      {
        ...
        icon: <UserIcon className="w-6 h-6" />,
        metrics: [
          { label: 'Visibility', value: '42%', trend: '+15%' },
          { label: 'Engagement', value: '35%', trend: '+10%' },
          { label: 'Intent', value: 'Medium', trend: '+20%' }
        ],
        details: {
          influence: 75,
          responsibilities: [
      ...
      },
      {
        ...
        icon: <UserIcon className="w-6 h-6" />,
        metrics: [
          { label: 'Visibility', value: '38%', trend: '+14%' },
          { label: 'Engagement', value: '32%', trend: '+8%' },
          { label: 'Intent', value: 'Medium', trend: '+15%' }
        ],
        details: {
          influence: 70,
          responsibilities: [
        ...
        {personas.map((persona) => (
          <Card
            ...
            onClick={() => {
                  ...
                  journeyStages: [
                    {
                      ...
                      queries: [
                        {
                          text: 'database schema automation tools',
                          volume: 2800,
                          position: 3,
                          sentiment: 'Positive'
                        },
                        {
                          text: 'how to manage database migrations',
                          volume: 1900,
                          position: 2,
                          sentiment: 'Positive'
                        }
                      ...
                      content: [
                        {
                          type: 'Blog',
                          title: 'Database CI/CD Best Practices',
                          impact: 85
                        },
                        {
                          type: 'Documentation',
              ...
              setActivePath([...activePath, { id: persona.id, name: persona.title, level: 'persona' }]);
            }}
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-blue-50 rounded-lg">
  ...
  // Update the vertical level case in renderFunnelLevel to show personas
  if (currentLevel === 'vertical') {
    return (
      <div className="space-y-6">
        <Card className="bg-white p-6">
          {/* ... existing vertical overview content ... */}
        </Card>

        {/* Update Buyer Personas section */}
        <div>
  ...
  if (currentLevel === 'persona') {
    return (
      <div className="space-y-6">
        <Card className="bg-white p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Text className="text-sm text-gray-500">{activeNode.title}</Text>
          ...
          <div className="grid grid-cols-2 gap-6">
            <Card decoration="left" decorationColor="blue" className="bg-white/50">
              <Title className="text-lg mb-4">Key Responsibilities</Title>
              <div className="space-y-2">
                {activeNode.details.responsibilities.map((item, index) => (
            ...
            <Card decoration="left" decorationColor="amber" className="bg-white/50">
              <Title className="text-lg mb-4">Pain Points</Title>
              <div className="space-y-2">
                {activeNode.details.painPoints.map((item, index) => (
                  <div key={index} className="flex items-center gap-2">
            ...
            <Card decoration="left" decorationColor="emerald" className="bg-white/50">
              <Title className="text-lg mb-4">Goals</Title>
              <div className="space-y-2">
                {activeNode.details.goals.map((item, index) => (
                  <div key={index} className="flex items-center gap-2">
            ...
            <Card decoration="left" decorationColor="violet" className="bg-white/50">
              <Title className="text-lg mb-4">Decision Influence</Title>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <Text>Overall Influence</Text>
                  <Text className="font-medium">{activeNode.details.influence}%</Text>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-2">
                  <div
                    className="bg-violet-500 h-2 rounded-full transition-all duration-500"
                    style={{ width: `${activeNode.details.influence}%` }}
                  />
                </div>
              </div>
            </Card>
        ...
        <Card className="bg-white p-6">
          <Title className="text-xl mb-6">Buying Journey Stages</Title>
          {/* I'll continue with the Journey Stages implementation in the next update */}
        </Card>
      </div>
    );
  }
