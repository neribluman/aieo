                  ...
                  >
                    {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                      ...
                      return (
                        ...
                        >
                          <details className="group bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-all duration-200">
                            <summary className="flex items-center justify-between cursor-pointer hover:bg-gray-50">
                              <div className="grid items-center w-full" style={{ gridTemplateColumns: '1fr repeat(5, 80px)' }}>
