                          ...
                          <Card decoration="left" decorationColor="violet" className="bg-white/60">
                            ...
                            <div className="space-y-4">
                              <table className="w-full">
                                ...
                                <tbody>
                                  <tr>
                                    <td className="text-sm">Company Mentioned</td>
                          ...
                          <Card decoration="left" decorationColor="amber" className="bg-white/60">
                            ...
                            <div className="space-y-2">
                              <div className="p-3 rounded-lg bg-blue-50">
                                ...
                                <Text className="text-sm text-blue-600 mt-1">
                                  {competitor.trend === 'up' ? 'Upward trend' : competitor.trend === 'down' ? 'Downward trend' : 'Stable'} in visibility 
                                  with {competitor.trend === 'up' ? '+' : competitor.trend === 'down' ? '-' : ''} change over last period
                                </Text>
                              </div>
                              <div className="p-3 rounded-lg bg-emerald-50">
