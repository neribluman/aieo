                  ...
                  {Object.entries(metricConfig).map(([key, config]) => (
                    <Tab 
                      ...
                      className="px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 
                        ui-not-selected:bg-white ui-not-selected:text-gray-600 ui-not-selected:hover:bg-gray-50
                        ui-selected:bg-blue-50 ui-selected:text-blue-600 ui-selected:shadow-sm
