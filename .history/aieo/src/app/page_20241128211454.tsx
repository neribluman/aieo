...
export default function VisibilityDashboard() {
  ...
  const transformDataForChart = (metric: typeof selectedMetric) => {
    ...
    const formattedData = uniqueDates.map(date => {
      ...
      // Format date to show month and year more clearly
                ...
                {Object.entries(metricConfig).map(([key, config]) => (
                  <TabPanel key={key}>
                    <LineChart
                      ...
                      showAnimation={true}
                      showLegend={true}
                      curveType="linear"  // Changed from monotone to linear for less smoothing
                      showGridLines={true}
                      showXAxis={true}
                      showYAxis={true}
                      ...
                      tickGap={20}  // Adjust this value to control tick density
                    />
                  </TabPanel>
                ))}
              </TabPanels>
