    ...
    <main className="relative">
      ...
      <div className="h-screen relative overflow-hidden bg-gradient-to-b from-white via-purple-50 to-white">
        ...
        <div className="relative z-10 h-screen flex flex-col">
          {/* Hero Section */}
          <div className="flex-1 flex items-start justify-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
            <motion.div 
            ...
            >
              ...
              >
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-geist-sans font-light tracking-tight text-gray-900">
                  Shape how
                  <motion.span 
                    className="block mt-2 mb-2 font-normal bg-gradient-to-r from-[#2E0854] to-[#9400D3] text-transparent bg-clip-text leading-tight py-1"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
