...
interface Citation {
  ...
  url: string;
  source: {
    type: 'Documentation' | 'Blog' | 'GitHub' | 'Guide' | 'Tutorial' | 'News' | 'Forum';
    lastUpdated: string;
...
// Update the TransitionWrapper component with proper types
interface TransitionWrapperProps {
  children: React.ReactNode;
  isVisible: boolean;
}

function TransitionWrapper({ children, isVisible }: TransitionWrapperProps) {
  return (
    <div
      className={`
...
export default function VisibilityDashboard() {
  ...
  const competitorData: CompetitorData[] = [
    {
      ...
      topSources: [
        { 
          name: "Database DevOps Report 2024",
  ...
  const [queries, setQueries] = useState<QueryPerformance[]>(() => 
    Array.from({ length: 500 }, (_, i) => ({
      ...
      buyingJourney: sampleQueries[i % sampleQueries.length].buyingJourney as "Problem Exploration" | "Solution Education" | "Solution Comparison" | "Solution Evaluation" | "Final Research",
