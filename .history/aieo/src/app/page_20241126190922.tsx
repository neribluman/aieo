  ...
  const topCitations: Citation[] = [
    {
      ...
      date: '2024-02-15',
      citationType: 'Direct',
      context: 'According to Ariga.io\'s schema migration guide, versioned migrations provide better traceability and rollback capabilities compared to automated schema diff tools.',
      sentiment: 'Positive',
      reach: 8500,
      otherCompanies: [
        { name: 'Redgate', sentiment: 'Neutral' },
        { name: 'Liquibase', sentiment: 'Neutral' }
      ],
      attention: {
        type: 'Opportunity',
        message: 'High citation rate for migration guide - consider expanding with more real-world examples'
      }
    },
    {
      id: '2',
                    ...
                    <div className="p-4 border-t border-gray-200 bg-gray-50">
                      <Grid numItems={2} className="gap-4">
                        <Card decoration="left" decorationColor="blue" className="bg-white/50">
                          <Text className="text-sm font-medium mb-2">Citation Context</Text>
                          <Text className="text-sm text-gray-600 italic">"{citation.context}"</Text>
                          
                          <div className="mt-4">
                            <Text className="text-sm font-medium mb-2">Other Companies Mentioned</Text>
                            <div className="flex flex-wrap gap-2">
                              {citation.otherCompanies.map((company, idx) => (
                                <Badge 
                                  key={idx}
                                  color={
                                    company.sentiment === 'Positive' ? 'green' :
                                    company.sentiment === 'Negative' ? 'red' : 'gray'
                                  }
                                  size="sm"
                                >
                                  {company.name}
