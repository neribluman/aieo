...
export default function VisibilityDashboard() {
  ...
  const visibilityMapData: MapData[] = [
    { country: "us", value: 62 }, // North America
    { country: "ca", value: 58 }, // North America
    { country: "gb", value: 45 }, // Europe
    { country: "de", value: 42 }, // Europe
    { country: "fr", value: 40 }, // Europe
    { country: "jp", value: 28 }, // Asia Pacific
    { country: "au", value: 25 }, // Asia Pacific
    { country: "sg", value: 22 }, // Asia Pacific
    { country: "br", value: 18 }, // Latin America
    { country: "mx", value: 15 }, // Latin America
  ];
  ...
  return (
    <div className="p-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Fourth Row - Regional & ICP Analysis */}
                    ...
                    <div className="absolute inset-0">
                      <WorldMap
                        ...
                        tooltip={({ country, value }) => (
                          <div className="bg-white/90 p-2 rounded-lg shadow-lg border border-gray-200">
                            <Text className="font-medium">{country}</Text>
                            <Text className="text-sm">Visibility Score: {value}%</Text>
                          </div>
                        )}
                        styleFunction={(country, value) => {
                          if (value) {
                            const opacity = value / 100; // normalize to 0-1
                            return {
                              fill: `rgba(59, 130, 246, ${opacity})`, // blue-500 with opacity
