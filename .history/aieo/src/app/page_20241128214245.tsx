...
import { Card, Title, LineChart, Grid, Text, Metric, Flex, Tab, TabPanels, TabPanel, Badge } from '@tremor/react';
    ...
    <div className="p-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="bg-white/50 backdrop-blur-sm shadow-glow mb-6">
          <div className="p-4">
            <Tab.Group 
              selectedIndex={Object.keys(metricConfig).indexOf(selectedMetric)}
              onChange={(index) => setSelectedMetric(Object.keys(metricConfig)[index] as typeof selectedMetric)}
            >
                  ...
                  {Object.entries(metricConfig).map(([key, config]) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <svg 
                          className={`w-4 h-4 ${selected ? 'block' : 'hidden'}`} 
                          fill="none" 
                          viewBox="0 0 24 24" 
                          stroke="currentColor"
                        >
