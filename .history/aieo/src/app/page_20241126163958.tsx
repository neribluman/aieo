                  ...
                  >
                    {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                      ...
                      return (
                        ...
                        >
                          <details className="group border-b border-gray-200 transition-all duration-300 ease-in-out">
                            <summary className="cursor-pointer hover:bg-blue-50 transition-colors list-none">
                              <div className="grid items-center" style={{ gridTemplateColumns: '1fr repeat(5, 80px)' }}>
                                <div className="px-3 py-2 min-w-0 flex items-center gap-2">
                                  <svg 
                                    className="w-4 h-4 text-gray-400 transform transition-transform duration-300 ease-in-out group-open:rotate-90" 
                                    fill="none" 
                                    viewBox="0 0 24 24" 
                                    stroke="currentColor"
                                  >
                            ...
                            <div className="overflow-hidden transition-[max-height,opacity] duration-300 ease-in-out max-h-0 opacity-0 group-open:max-h-[1000px] group-open:opacity-100">
