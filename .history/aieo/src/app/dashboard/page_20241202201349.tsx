            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex items-center justify-between mb-8">
                <div className="space-y-4">
                  <h1 className={cn(
                    "text-4xl font-bold tracking-tight lg:text-5xl bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900",
                  ...
                  <div className="h-1 w-24 bg-gradient-to-r from-blue-500 to-blue-800 rounded-full" />
                </div>
                <SidebarTrigger />
              </div>
