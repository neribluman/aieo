  ...
  const citationLeaderboard = [
    { 
      ...
      analysis: {
        ...
        citationContext: "Often cited for ORM capabilities",
        marketShare: "32%",
        recentUpdates: "Released Prisma Platform"
      }
    },
    { 
      company: 'Dataedo', 
      ...
      analysis: {
        ...
        citationContext: "Referenced for documentation features",
        marketShare: "28%",
        recentUpdates: "Enhanced SQL Server support"
      }
    },
    { 
      company: 'Couchbase', 
      ...
      analysis: {
        ...
        citationContext: "Cited for distributed systems",
        marketShare: "25%",
        recentUpdates: "Launched Capella DBaaS"
      }
    },
    { 
      company: 'SchemaHero', 
      ...
      analysis: {
        ...
        citationContext: "Popular in cloud-native discussions",
        marketShare: "19%",
        recentUpdates: "Added MongoDB support"
      }
    },
    { 
      company: 'Ariga.io', 
      ...
      analysis: {
        ...
        citationContext: "Rising mentions in DevOps practices",
        marketShare: "8%",
        recentUpdates: "Launched Atlas Cloud"
      }
    },
  ];
