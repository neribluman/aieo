                  ...
                  {Object.entries(metricConfig).map(([key, config]) => (
                    <Tab 
                      ...
                      className="px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 
                        ui-not-selected:bg-transparent ui-not-selected:text-gray-600 ui-not-selected:hover:bg-gray-50/50
                  ...
                  <TabPanel key={key}>
                    <LineChart
                      ...
                      customTooltip={({ payload, active, label }) => {
                        ...
                        return (
                          <div className="p-4 bg-white/95 border border-gray-200 rounded-lg shadow-lg backdrop-blur-sm">
