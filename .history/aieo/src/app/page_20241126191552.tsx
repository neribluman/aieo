...
interface Citation {
  ...
  platform: string;
  date: string;
  citationType: 'Direct' | 'Comparison' | 'List' | 'Review';
  context: string;
  ...
  const topCitations: Citation[] = [
    {
      ...
      date: '2024-02-15',
      citationType: 'Direct',
      context: 'Referenced in discussions about enterprise-grade schema management practices',
      quote: "Ariga.io's versioned migrations provide better traceability and rollback capabilities compared to automated schema diff tools, making it particularly suitable for enterprise environments.",
      sentiment: 'Positive',
      reach: 8500,
      metrics: {
        totalQueries: 142,
        ...
        engineReferences: [
          { platform: 'Claude', count: 58, percentage: 41 },
          { platform: 'Perplexity', count: 42, percentage: 30 },
          { platform: 'Gemini', count: 28, percentage: 20 },
          { platform: 'SearchGPT', count: 14, percentage: 9 }
        ]
      },
      source: {
        type: 'Documentation',
    ...
    },
    {
      ...
      date: '2024-02-10',
      citationType: 'Review',
      context: 'Atlas CLI by Ariga.io offers a unique approach to schema management through its declarative syntax and version control integration.',
      quote: "Atlas CLI provides a unique declarative approach to schema management, making it particularly appealing for teams using GitOps practices.",
      sentiment: 'Positive',
      reach: 6200,
      metrics: {
        totalQueries: 98,
        ...
        engineReferences: [
          { platform: 'Perplexity', count: 42, percentage: 43 },
          { platform: 'Claude', count: 28, percentage: 29 },
          { platform: 'Gemini', count: 18, percentage: 18 },
          { platform: 'SearchGPT', count: 10, percentage: 10 }
        ]
      },
      source: {
        type: 'Documentation',
    ...
    },
    {
      ...
      context: 'While tools like Redgate focus on GUI-based management, Ariga.io emphasizes Git-based workflow for schema changes.',
      quote: "Unlike traditional GUI-based tools, Ariga.io's approach centers on Git-workflow integration, making it a natural fit for modern DevOps practices.",
      sentiment: 'Neutral',
      reach: 4800,
      metrics: {
        totalQueries: 76,
        ...
        engineReferences: [
          { platform: 'Gemini', count: 35, percentage: 46 },
          { platform: 'Claude', count: 22, percentage: 29 },
          { platform: 'Perplexity', count: 19, percentage: 25 }
        ]
      },
      source: {
        type: 'Blog',
    ...
    },
    {
      ...
      date: '2024-01-15',
      citationType: 'Direct',
      context: 'Atlas by Ariga.io provides robust schema management capabilities with its open-source offering.',
      quote: "Atlas stands out in the open-source space with its comprehensive approach to schema management and strong community support.",
      sentiment: 'Positive',
      reach: 3900,
      metrics: {
        totalQueries: 65,
        ...
        engineReferences: [
          { platform: 'Claude', count: 30, percentage: 46 },
          { platform: 'Perplexity', count: 20, percentage: 31 },
          { platform: 'Gemini', count: 15, percentage: 23 }
        ]
      },
      source: {
        type: 'GitHub',
    ...
    },
    {
      ...
      date: '2024-01-12',
      citationType: 'List',
      context: 'For CI/CD integration of database changes, Ariga.io provides automated validation and deployment workflows.',
      quote: "Ariga.io's CI/CD integration capabilities enable automated validation and deployment of database changes, reducing manual intervention and potential errors.",
      sentiment: 'Positive',
      reach: 3500,
      metrics: {
        totalQueries: 58,
        ...
        engineReferences: [
          { platform: 'Perplexity', count: 25, percentage: 43 },
          { platform: 'Claude', count: 18, percentage: 31 },
          { platform: 'Gemini', count: 15, percentage: 26 }
        ]
      },
      source: {
        type: 'Guide',
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                  <Badge color="emerald">5 Active Citations</Badge>
                  <Badge color="blue">0.5% Citation Rate</Badge>
                  <Badge color="amber">26.9k Total Reach</Badge>
                </div>
              </div>
                    ...
                    <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex gap-3 mt-1 text-sm text-gray-500">
                          ...
                          <span>•</span>
                          <span>{citation.citationType}</span>
                          <span>•</span>
                          <span>{citation.reach.toLocaleString()} Views</span>
                        </div>
                      </div>
                      <svg 
                    ...
                    <div className="p-4 border-t border-gray-200 bg-gray-50">
                      <Grid numItems={2} className="gap-4">
                        <Card decoration="left" decorationColor="blue" className="bg-white/50">
                          ...
                          <div className="space-y-4">
                            <div>
                              <Text className="text-xs text-gray-500 mb-1">Direct Quote</Text>
                              <Text className="text-sm text-gray-600 italic">"{citation.quote}"</Text>
                            </div>

                            <div>
                              <Text className="text-xs text-gray-500 mb-2">Query Distribution</Text>
                              <div className="flex items-center gap-2">
                                <div className="flex-1 bg-gray-100 rounded-full h-2">
                                  <div 
                                    className="h-2 rounded-full bg-blue-500"
                                    style={{ width: `${(citation.metrics.queryBreakdown.awareness / citation.metrics.totalQueries) * 100}%` }}
                                  />
                                </div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <div className="flex-1 bg-gray-100 rounded-full h-2">
                                  <div 
                                    ...
                                    style={{ width: `${(citation.metrics.queryBreakdown.consideration / citation.metrics.totalQueries) * 100}%` }}
                                  />
                                </div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <div className="flex-1 bg-gray-100 rounded-full h-2">
                                  <div 
                                    ...
                                    style={{ width: `${(citation.metrics.queryBreakdown.decision / citation.metrics.totalQueries) * 100}%` }}
                                  />
                                </div>
                            ...
                            <div>
                              <Text className="text-xs text-gray-500 mb-2">Engine References</Text>
                              <div className="grid grid-cols-2 gap-2">
                                {citation.metrics.engineReferences.map(engine => (
                                  <div key={engine.platform} className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-1">
                                      <Text className="text-xs font-medium">{engine.count}</Text>
                                      <Text className="text-xs text-gray-500">({engine.percentage}%)</Text>
                                    </div>
                                  </div>
                                ))}
                              </div>
                                  ...
                                  <div key={idx} className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                      <Badge 
                                        size="sm"
                                        color={
                                          competitor.sentiment === 'Positive' ? 'green' :
                                          competitor.sentiment === 'Negative' ? 'red' : 'gray'
                                        }
                                      >
                                        {competitor.company}
                                      </Badge>
                                    ...
                                    <Text className="text-xs">{competitor.frequency} mentions</Text>
                                  </div>
                                ))}
                              </div>
                            </div>
                        ...
                        <Card decoration="left" decorationColor="blue" className="bg-white/50">
                          ...
                          <div className="space-y-4">
                            <div>
                              <Text className="text-xs text-gray-500">Citation Type</Text>
                              <Text className="font-medium">{citation.citationType}</Text>
                            </div>

                            <div>
                              <Text className="text-xs text-gray-500">Reach</Text>
                              <Text className="font-medium">{citation.reach.toLocaleString()} Views</Text>
                            </div>
