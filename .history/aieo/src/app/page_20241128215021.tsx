          ...
          <div className="p-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                ...
                <TabList className="flex flex-wrap gap-2 p-1.5 bg-gray-100/80 backdrop-blur-sm rounded-lg">
                  {Object.entries(metricConfig).map(([key, config]) => (
                    <Tab 
                      ...
                      className={`
                        ...
                        data-[selected=true]:bg-white data-[selected=true]:text-blue-600 data-[selected=true]:shadow-sm
                        data-[selected=false]:bg-transparent data-[selected=false]:text-gray-600 data-[selected=false]:hover:bg-white/50
                        after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:rounded-full
                        data-[selected=true]:after:bg-blue-500
                      `}
                    >
                      <div className="flex items-center gap-2">
                        {config.title}
                        <div className="data-[selected=true]:opacity-100 opacity-0 transition-opacity">
              ...
              <TabPanels>
                {Object.entries(metricConfig).map(([key, config]) => (
                  <TabPanel key={key} className="focus:outline-none">
                    <div className="p-4 bg-white/50 backdrop-blur-sm rounded-lg border border-gray-200/50">
                      <LineChart
                        className="h-96"
