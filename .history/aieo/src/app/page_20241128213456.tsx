...
export default function VisibilityDashboard() {
  ...
  // First, update the aiEngineTimeSeries data to show more realistic trends
  const aiEngineTimeSeries: AIEngineTimeSeriesData[] = [
    // Perplexity - showing downward trend
    { date: '2024-01-01', engine: 'Perplexity', avgSentiment: 0.45, avgPosition: 4.5, visibilityRate: 28, recommendationProb: 25 },
    { date: '2024-02-01', engine: 'Perplexity', avgSentiment: 0.42, avgPosition: 4.8, visibilityRate: 25, recommendationProb: 22 },
    { date: '2024-03-01', engine: 'Perplexity', avgSentiment: 0.38, avgPosition: 5.2, visibilityRate: 22, recommendationProb: 20 },
    { date: '2024-04-01', engine: 'Perplexity', avgSentiment: 0.35, avgPosition: 5.5, visibilityRate: 20, recommendationProb: 18 },
    { date: '2024-05-01', engine: 'Perplexity', avgSentiment: 0.32, avgPosition: 5.8, visibilityRate: 18, recommendationProb: 15 },
    
    // Claude - showing slight upward trend
    { date: '2024-01-01', engine: 'Claude', avgSentiment: 0.30, avgPosition: 5.0, visibilityRate: 15, recommendationProb: 12 },
    { date: '2024-02-01', engine: 'Claude', avgSentiment: 0.32, avgPosition: 4.8, visibilityRate: 18, recommendationProb: 15 },
    { date: '2024-03-01', engine: 'Claude', avgSentiment: 0.35, avgPosition: 4.5, visibilityRate: 20, recommendationProb: 18 },
    { date: '2024-04-01', engine: 'Claude', avgSentiment: 0.38, avgPosition: 4.2, visibilityRate: 22, recommendationProb: 20 },
    { date: '2024-05-01', engine: 'Claude', avgSentiment: 0.40, avgPosition: 4.0, visibilityRate: 25, recommendationProb: 22 },
    
    // Gemini - showing stable low trend
    { date: '2024-01-01', engine: 'Gemini', avgSentiment: 0.25, avgPosition: 5.5, visibilityRate: 12, recommendationProb: 10 },
    { date: '2024-02-01', engine: 'Gemini', avgSentiment: 0.26, avgPosition: 5.4, visibilityRate: 13, recommendationProb: 11 },
    { date: '2024-03-01', engine: 'Gemini', avgSentiment: 0.24, avgPosition: 5.6, visibilityRate: 11, recommendationProb: 9 },
    { date: '2024-04-01', engine: 'Gemini', avgSentiment: 0.25, avgPosition: 5.5, visibilityRate: 12, recommendationProb: 10 },
    { date: '2024-05-01', engine: 'Gemini', avgSentiment: 0.23, avgPosition: 5.7, visibilityRate: 10, recommendationProb: 8 },
    
    // SearchGPT - showing very low trend
    { date: '2024-01-01', engine: 'SearchGPT', avgSentiment: 0.20, avgPosition: 6.0, visibilityRate: 8, recommendationProb: 6 },
    { date: '2024-02-01', engine: 'SearchGPT', avgSentiment: 0.18, avgPosition: 6.2, visibilityRate: 7, recommendationProb: 5 },
    { date: '2024-03-01', engine: 'SearchGPT', avgSentiment: 0.19, avgPosition: 6.1, visibilityRate: 7, recommendationProb: 5 },
    { date: '2024-04-01', engine: 'SearchGPT', avgSentiment: 0.17, avgPosition: 6.3, visibilityRate: 6, recommendationProb: 4 },
    { date: '2024-05-01', engine: 'SearchGPT', avgSentiment: 0.16, avgPosition: 6.4, visibilityRate: 5, recommendationProb: 3 },
    
    // MetaAI - showing very low trend
    { date: '2024-01-01', engine: 'MetaAI', avgSentiment: 0.15, avgPosition: 6.5, visibilityRate: 5, recommendationProb: 3 },
    { date: '2024-02-01', engine: 'MetaAI', avgSentiment: 0.14, avgPosition: 6.6, visibilityRate: 4, recommendationProb: 2 },
    { date: '2024-03-01', engine: 'MetaAI', avgSentiment: 0.13, avgPosition: 6.7, visibilityRate: 4, recommendationProb: 2 },
    { date: '2024-04-01', engine: 'MetaAI', avgSentiment: 0.12, avgPosition: 6.8, visibilityRate: 3, recommendationProb: 1 },
    { date: '2024-05-01', engine: 'MetaAI', avgSentiment: 0.11, avgPosition: 6.9, visibilityRate: 3, recommendationProb: 1 },
  ];
          ...
          <div className="p-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                ...
                <TabList className="flex gap-2 p-1 bg-gray-100/50 rounded-lg">
                  {Object.entries(metricConfig).map(([key, config]) => (
                    <Tab 
                      key={key} 
                      className="px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 
                        ui-not-selected:bg-transparent ui-not-selected:text-gray-600 
                        ui-selected:bg-blue-600 ui-selected:text-white
